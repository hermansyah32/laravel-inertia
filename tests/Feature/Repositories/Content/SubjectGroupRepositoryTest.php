...
class SubjectGroupRepositoryTest extends TestCase
{
    ...
    public function test_subject_groups_index_repository()
    {
    ...
    public function test_subject_groups_index_with_search_repository()
    {
        $subjectGroup = SubjectGroup::factory()->create();
    ...
    public function test_subject_groups_index_trashed_repository()
    {
        $subjectGroup = SubjectGroup::factory()->create();
        $subjectGroup->delete();
    ...
    public function test_subject_groups_index_trashed_with_search_repository()
    {
        $subjectGroup = SubjectGroup::factory()->create();
        $subjectGroup->delete();
    ...
    public function test_subject_groups_create_repository()
    {
        $input = [
            'name' => 'Subject Group ' . fake()->randomLetter(),
            'subject_id' => fake()->uuid(),
            'order' => fake()->randomNumber(),
        ];

        /** @var BodyResponse $result */
        $store =  App::call(function (SubjectGroupRepository $repository) use ($input) {
            return $repository->create($input);
        });

        $this->assertInstanceOf(BodyResponse::class, $store);
        $this->assertSame($store->getResponseCode()->value, ResponseCode::OK->value);
        $this->assertSame($input['name'], $store->getBodyData()->name);
    }

    public function test_subject_groups_get_repository()
    {
        $subjectGroup = SubjectGroup::factory()->create();
    ...
    public function test_subject_groups_get_trashed_repository()
    {
        $subjectGroup = SubjectGroup::factory()->create();
        $subjectGroup->delete();
    ...
    public function test_subject_groups_update_repository()
    {
        $subjectGroup = SubjectGroup::factory()->create();
    ...
    public function test_subject_groups_restore_repository()
    {
        $subjectGroup = SubjectGroup::factory()->create();
        $subjectGroup->delete();
    ...
    public function test_subject_groups_delete_repository()
    {
        $subjectGroup = SubjectGroup::factory()->create();
    ...
    public function test_subject_groups_delete_permanently_repository()
    {
        $subjectGroup = SubjectGroup::factory()->create();
        $subjectGroup->delete();

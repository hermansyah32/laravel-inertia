...
class SubjectReferenceRepositoryTest extends TestCase
{
    ...
    public function test_subject_references_index_repository()
    {
    ...
    public function test_subject_references_index_with_search_repository()
    {
        $subjectReference = SubjectReference::factory()->create();
    ...
    public function test_subject_references_index_trashed_repository()
    {
        $subjectReference = SubjectReference::factory()->create();
    ...
    public function test_subject_references_index_trashed_with_search_repository()
    {
        $subjectReference = SubjectReference::factory()->create();
        $subjectReference->delete();
    ...
    public function test_subject_references_create_repository()
    {
        $input = [
            'subject_content_id' => fake()->uuid(),
            'name' => 'Reference ' . fake()->randomLetter(),
            'url' => fake()->url()
        ];

        /** @var BodyResponse $result */
        $result =  App::call(function (SubjectReferenceRepository $repository) use ($input) {
    ...
    public function test_subject_references_get_repository()
    {
        $subjectReference = SubjectReference::factory()->create();
    ...
    public function test_subject_references_get_trashed_repository()
    {
        $subjectReference = SubjectReference::factory()->create();
        $subjectReference->delete();
    ...
    public function test_subject_references_update_repository()
    {
        $subjectReference = SubjectReference::factory()->create();
    ...
    public function test_subject_references_restore_repository()
    {
        $subjectReference = SubjectReference::factory()->create();
        $subjectReference->delete();
    ...
    public function test_subject_references_delete_repository()
    {
        $subjectReference = SubjectReference::factory()->create();
    ...
    public function test_subject_references_delete_permanently_repository()
    {
        $subjectReference = SubjectReference::factory()->create();
        $subjectReference->delete();

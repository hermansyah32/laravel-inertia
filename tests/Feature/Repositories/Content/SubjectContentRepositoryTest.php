...
class SubjectContentRepositoryTest extends TestCase
{
    ...
    public function test_subject_contents_index_repository()
    {
    ...
    public function test_subject_contents_index_with_search_repository()
    {
        $subjectContent = SubjectContent::factory()->create();
    ...
    public function test_subject_contents_index_trashed_repository()
    {
        $subjectContent = SubjectContent::factory()->create();
    ...
    public function test_subject_contents_index_trashed_with_search_repository()
    {
        $subjectContent = SubjectContent::factory()->create();
        $subjectContent->delete();
    ...
    public function test_subject_contents_create_repository()
    {
        $input = [
            'subject_group_id' => fake()->uuid(),
            'order' => fake()->randomNumber(),
            'title' => 'title' . fake()->randomLetter(),
            'content' => fake()->paragraph()
        ];

        /** @var BodyResponse $result */
        $result =  App::call(function (SubjectContentRepository $repository) use ($input) {
            return $repository->create($input);
        });

        $this->assertInstanceOf(BodyResponse::class, $result);
        $this->assertSame($result->getResponseCode()->value, ResponseCode::OK->value);
        $this->assertSame($input['title'], $result->getBodyData()->title);
    }

    public function test_subject_contents_get_repository()
    {
        $subjectContent = SubjectContent::factory()->create();
    ...
    public function test_subject_contents_get_trashed_repository()
    {
        $subjectContent = SubjectContent::factory()->create();
        $subjectContent->delete();
    ...
    public function test_subject_contents_update_repository()
    {
        $subjectContent = SubjectContent::factory()->create();
    ...
    public function test_subject_contents_restore_repository()
    {
        $subjectContent = SubjectContent::factory()->create();
        $subjectContent->delete();
    ...
    public function test_subject_contents_delete_repository()
    {
        $subjectContent = SubjectContent::factory()->create();
    ...
    public function test_subject_contents_delete_permanently_repository()
    {
        $subjectContent = SubjectContent::factory()->create();
        $subjectContent->delete();
